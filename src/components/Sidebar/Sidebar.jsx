...
export default function Sidebar() {
	...
	return (
		<aside className="inline-flex flex-col items-center justify-between min-h-screen px-2 py-8 bg-white border-r sm:px-4 ">
			<nav className="flex flex-col items-center flex-1 space-y-6 ">
				<a onClick={() => setExtended((prev) => !prev)} href="#">
					<svg
				...
				<a
					className="flex justify-center gap-2 px-3 py-3 font-semibold bg-gray-100 rounded-3xl"
					href="#"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<div className="flex flex-col space-y-2">
				<a
					className="flex items-center gap-3 px-3 py-2 text-sm font-semibold hover:bg-gray-100 hover:rounded-3xl"
					href="#"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
